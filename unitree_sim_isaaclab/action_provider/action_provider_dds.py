...
class DDSActionProvider(ActionProvider):
    ...
    def _setup_joint_mapping(self):
        ...
        if self.enable_robot == "g129":
            ...
            # Waist mapping (boy-order indices 12..14)
            ...
            self._waist_source_indices = [idx for idx in self.waist_joint_mapping.values()]
        ...
        if hasattr(self, "_waist_target_indices") and hasattr(self, "_waist_source_indices"):
            ...
            if self.enable_robot == "g129" and self.robot_dds:
                ...
                if cmd_data and 'motor_cmd' in cmd_data:
                    ...
                    if len(positions) >= 29:
                        ...
                        if hasattr(self, "_waist_source_idx_t"):
