...
|    ⚙️ Flag    |                        📜 Description                         |
| :----------: | :----------------------------------------------------------: |
|  `--record`  | Enable **data recording**<br />After pressing **r** to start, press **Space** to start/stop saving an episode. Can repeat. |
...
8. During teleoperation, press **Space** to start recording; press **Space** again to stop and save. Repeatable process.
