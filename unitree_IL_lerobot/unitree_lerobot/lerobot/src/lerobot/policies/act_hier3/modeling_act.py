...
class ACTHier3Policy(PreTrainedPolicy):
    """
    Action Chunking Transformer Policy as per Learning Fine-Grained Bimanual Manipulation with Low-Cost
    Hardware (paper: https://huggingface.co/papers/2304.13705, code: https://github.com/tonyzhaozh/act)
    """

    config_class = ACTHier3Config
    name = "act_hier3"

    def __init__(
        self,
        config: ACTHier3Config,
...
class ACT(nn.Module):
    ...
    def __init__(self, config: ACTHier3Config):
    ...
    def forward(self, batch: dict[str, Tensor]) -> tuple[Tensor, tuple[Tensor, Tensor] | tuple[None, None]]:
        ...
        # Arm decoder: keep fresh queries, but extend encoder memory with waist tokens.
        ...
        # Hand decoder: condition on encoder, waist, and arm latents.
        hand_memory = torch.cat([encoder_out, waist_tokens, arm_tokens], dim=0)
...
class ACTEncoder(nn.Module):
    ...
    def __init__(self, config: ACTHier3Config, is_vae_encoder: bool = False):
        super().__init__()
