...
class ACT(nn.Module):
    """Action Chunking Transformer: The underlying neural network for ACTHierDualAdapPolicy.
    ...
    def forward(self, batch: dict[str, Tensor]) -> tuple[Tensor, tuple[Tensor, Tensor] | tuple[None, None]]:
        ...
        waist_pos = decoder_pos.expand(-1, gated_waist_tokens.shape[1], -1)
