...
class ACT(nn.Module):
    ...
    def _reset_parameters(self):
        ...
        for head in (self.waist_head, self.arm_head, self.hand_head, self.arm_gating.gate_net):
    ...
    def forward(self, batch: dict[str, Tensor]) -> tuple[Tensor, tuple[Tensor, Tensor] | tuple[None, None]]:
        ...
        # Stage 2: decode waist conditioned on gated arm/hand latents.
        ...
        waist_memory_pos = torch.cat(
            [
                encoder_in_pos_embed.expand(-1, gated_arm_tokens.shape[1], -1),
