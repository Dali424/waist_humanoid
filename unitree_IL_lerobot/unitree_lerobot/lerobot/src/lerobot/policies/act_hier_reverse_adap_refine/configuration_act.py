...
@PreTrainedConfig.register_subclass("act_hier_reverse_adap_refine")
@dataclass
class ACTHierReverseAdapRefineConfig(PreTrainedConfig):
    """Configuration class for the refined reverse adaptive ACT policy.
    ...
    def _maybe_init_head_dims(self) -> None:
        ...
        if action_feature is None:
            raise ValueError("`action` output feature is required for ACTHierConfig.")
