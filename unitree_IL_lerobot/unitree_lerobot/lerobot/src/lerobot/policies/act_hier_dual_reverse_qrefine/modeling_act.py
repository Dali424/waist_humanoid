...
class ACTHierDualReverseQRefinePolicy(PreTrainedPolicy):
    """Dual cross-attn ACT variant decoding arm/hand first, then waist."""

    config_class = ACTHierDualReverseQRefineConfig
    name = "act_hier_dual_reverse_qrefine"

    def __init__(
        self,
        config: ACTHierDualReverseQRefineConfig,
...
class ACT(nn.Module):
    ...
    def __init__(self, config: ACTHierDualReverseQRefineConfig):
        super().__init__()
        self.config = config
...
class ACTEncoder(nn.Module):
    def __init__(self, config: ACTHierDualReverseQRefineConfig, is_vae_encoder: bool = False):
        super().__init__()
