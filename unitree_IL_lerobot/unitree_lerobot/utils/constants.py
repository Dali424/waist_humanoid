...
# Variant: Inspire hands + arms + waist (3 DOF)
G1_INSPIRE_WAIST_CONFIG = RobotConfig(
    motors=[
        # Arms (L/R)
        "kLeftShoulderPitch",
        "kLeftShoulderRoll",
    ...
    # States and actions include body.qpos (3-DoF waist) appended to arms + hands
    json_state_data_name=["left_arm.qpos", "right_arm.qpos", "left_ee.qpos", "right_ee.qpos", "body.qpos"],
    json_action_data_name=["left_arm.qpos", "right_arm.qpos", "left_ee.qpos", "right_ee.qpos", "body.qpos"],
)
...
ROBOT_CONFIGS = {
    ...
    "Unitree_G1_Inspire_Waist": G1_INSPIRE_WAIST_CONFIG,
